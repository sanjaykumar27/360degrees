    ...
    <?php if ($pickupDetails != 0) {
        ?>
            <table class="table table-bordered table-hover">
                ...
                <tbody>
    <?php
    foreach ($pickupDetails['records'] as $key => $value) {
        if ($value['status'] == 1) {
...
?>
            ...
            <div class="col-lg-4">
                ...
                <input type="text" name="pickuppointname" id="pickuppointname" 
                       value="<?php
                       if (isset($PickupEditDetails['pickuppointname']) && !empty($PickupEditDetails['pickuppointname'])) {
            ...
            <div class="col-lg-4">
                ...
                <input type="text" name="amount" id="amount" 
                       value="<?php
                    if (isset($PickupEditDetails['amount']) && !empty($PickupEditDetails['amount'])) {
            ...
            <div class="col-lg-4">
                ...
                <input type="text" name="pickuptime" id="pickuptime" class="form-control" placeholder="HH:MM:SS"
                       value="<?php
                    if (isset($PickupEditDetails['pickuptime']) && !empty($PickupEditDetails['pickuptime'])) {
            ...
            <div class="col-lg-4">
                ...
                <input type="text" name="droptime" id="droptime" class="form-control" placeholder="HH:MM:SS" 
                       value="<?php
                    if (isset($PickupEditDetails['droptime']) && !empty($PickupEditDetails['droptime'])) {
