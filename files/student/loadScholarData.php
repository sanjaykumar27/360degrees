...
$sqlString="SELECT studentid, scholarnumber, CONCAT(firstname,' ',middlename,' ',lastname) as name  
         FROM tblstudent WHERE scholarnumber like('".$_POST['keyword']."%') OR firstname like('".$_POST['keyword']."%') AND status=1 AND deleted!=1 "
        . "AND instsessassocid=".$_POST['instid'];


$result=  dbSelect($sqlString);
$scholarlist="<ul class='list-group list-cust'>";
