...
<?php if (isset($_GET['edid'])) { ?>
          $(function () {
              displayHideDiv('addFeeRule', 'showFeeRuleList');
          });
  <?php } ?>
...
<div class="container" id='showFeeRuleList'>
    <?php
      ...
      foreach ($feeruleArray as $key => $value) {
          $arr[] = $value['feecomponent'];
          foreach ($arr as $k => $val) {
              $array = explode(',', $val);
              $feeruleArray[$key]['feecomponent'] = $array;
          }
      }
    ...
    <div class="col-lg-6" style="text-align: left; padding: 0px">
        <button type="button" id='addrule' class="btn btn-success" onclick="displayHideDiv('addFeeRule', 'showFeeRuleList')">Add Fee Rule</button>
    </div>
...
<div class="container" id="addFeeRule" style="display: none">
    <?php renderMsg(); ?>
    ...
    <form action="<?php echo PROCESS_FORM; ?>" method="post" name="imform">
        ...
        <div class="col-lg-4">
            ...
            <div class="input-group">
                <span class="input-group-addon">
                    <?php
                      if (isset($feeRuleDetails[0]['feerulemodeid']) && $feeRuleDetails[0]['feerulemodeid'] == '263') {
                    ...
                    <input type="radio" name="feerulemodeid" id="feerulemodeid1" 
                           value ="<?php
                             ...
                             echo $modeid;
                           ?>"  <?php echo $modeChecked1 ?> required> Percent &nbsp; 
                </span>
                <span class="input-group-addon">
                    <?php
                      if (isset($feeRuleDetails[0]['feerulemodeid']) && $feeRuleDetails[0]['feerulemodeid'] == '264') {
                    ...
                    <input  type="radio" name="feerulemodeid" id="feerulemodeid2"
                            value ="<?php
                              ...
                              echo $modeid;
                            ?>" <?php echo $modeChecked2 ?> required> Fixed &nbsp; &nbsp; &nbsp; 
                </span>
            </div>
        ...
        <div class="col-lg-4" >
            ...
            <div class="input-group" >
                <span class="input-group-addon">
                    <?php
                      if (isset($feeRuleDetails[0]['feeruletype']) && $feeRuleDetails[0]['feeruletype'] == '261') {
                    ...
                    <input type="radio" name="feeruletype" id="feeruletype1" 
                           value ="<?php
                             $typeid = feeruletype('Discount');
                             echo $typeid;
                           ?>" <?php echo $typeChecked1 ?> required="true"> Discount
                </span>
                <span class="input-group-addon">
                    <?php
                      if (isset($feeRuleDetails[0]['feeruletype']) && $feeRuleDetails[0]['feeruletype'] == '262') {
                    ...
                    <input type="radio" name="feeruletype" id="feeruletype2" 
                           value ="<?php
                             $typeid = feeruletype('Addition');
                             echo $typeid;
                           ?>" <?php echo $typeChecked2 ?>  required="true"> Addition
                </span>
        ...
        <div class="col-lg-4">
            ...
            <div class="input-group">
                <span class="input-group-addon">
                    <?php
                      if (isset($feeRuleDetails[0]['feerulestatus']) && $feeRuleDetails[0]['feerulestatus'] == '1') {
                ...
                <span class="input-group-addon">
                    <?php
                      if (isset($feeRuleDetails[0]['feerulestatus']) && $feeRuleDetails[0]['feerulestatus'] == '0') {
        ...
        <div class="controls" align="center">
            <button type="button" class="btn btn-success" align="center" id="showrule"  onclick="displayHideDiv('showFeeRuleList', 'addFeeRule')" >Show Fee Rule(s)</button>
...
<?php
  ...
  function feeRuleShowSelect() {
      ...
      $sql = "SELECT t1.feeruleid,LOWER(t1.feerulename) as feerulename,t2.feecomponentid,
        trim(t1.feeruleremarks) as feeruleremarks,t1.feerulestatus, GROUP_CONCAT(t3.feecomponent) as feecomponent
