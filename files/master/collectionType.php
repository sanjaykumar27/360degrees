...
<script type="text/javascript">
    ...
    if (<?php
  if (isset($_GET['edid']) && isset($_GET['mode']) == 'edit') {
      echo $_GET['edid'];
  } else {
      echo 0;
  }
              ...
              <div class="panel-group" id="accordion">
                  ...
                  if ($collectionTypeArray) {
                      foreach ($collectionTypeArray['records'] as $key) {
                          ...
                          ?>
                          <tr>
                              <td><a href="Javascript: none"><?php echo $sno ?></a></td>
                              <td><a href="Javascript: none" onclick="displayHideDiv('displaystructure<?php echo $sno; ?>', null)"><?php echo ucwords($key['mastercollectiontype']); ?></a></td>
                              <td ><?php echo hoverList($key['mastercollectiontypeid'], $key['status'], $page) ?></td>
                          </tr>
    ...
    <div class="container" id="addcollection">
        <div class="span10">
            ...
            <div class="row" id="itemRows">
                <?php
                  if (isset($_GET['edid']) && !empty($itemDetails['items'])) {
