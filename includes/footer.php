 ...
 * Page details here: simple footer for the app
 * Updates here: 
 */
?> 
       ...
       <div class="h4 col-lg-6 col-md-6">Copyright &copy <?php echo (date('Y')); ?> eBizneeds Business Solutions | All Rights Reserved  <br>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="social pull-right">
                ...
                <a href="#"><img src="<?php echo DIR_ASSET; ?>/images/social/twitter.png" alt="" ></a>
                <a href="#"><img src="<?php echo DIR_ASSET; ?>/images/social/dribbble.png" alt=""></a>
                <a href="#"><img src="<?php echo DIR_ASSET; ?>/images/social/rss.png" alt="" ></a>
            </div>
        </div>
    </div>
